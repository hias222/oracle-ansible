...
then
 ...
 $WGET  --load-cookies="$COOKIE_FILE" "https://updates.oracle.com/Orion/Services/download/p32421507_190000_Linux-x86-64.zip?aru=24187443&patch_file=p32421507_190000_Linux-x86-64.zip" -O "$OUTPUT_DIR/p32421507_190000_Linux-x86-64.zip"   >> "$LOGFILE" 2>&1 
